...
#config
logger.info('selenevis tool >> started!')
...
if option == "-station":
    ...
    dfs.append([df[['data']],'5-min interpolation','#2980b9',312,1.2,'o','None', 0, 0.05, 0.5])
    ...
    dfs.append([df[['data']],'Hourly SLEV','#FA8072',312,3.5,'o','None', 0, 0.05, 0.5])
    ...
    logger.error("Unknown option. Please, use -station <stationid> or -files <file1,file2,file3>")
